...
def run_fastqc(fastqc_path, input_files, output_dir, log_function):
    ...
    command = [fastqc_path, '-o', output_dir] + input_files
...
def run_fastqtosam(gatk_path, forward_read, reverse_read, output_bam, sample_name, platform, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_markilluminaadapters(gatk_path, input_bam, metrics_file, output_bam, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_samtofastq(gatk_path, input_bam, fastq_output, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_bwa_index(bwa_path, reference_sequence, algorithm, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_bwa_mem(bwa_path, reference_sequence, fastq_output, sam_output, threads, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
    log_file_path = os.path.join(logging_dir, 'bwa_mem_log_file.txt')
...
def run_create_sequence_dictionary(gatk_path, reference_sequence, output_dict, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_samtools_faidx(reference_sequence, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_samtools_view_unmapped(merge_bam_output, unmapped_output, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_sortsam(gatk_path, merge_bam_output, sorted_output, sort_order, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_setnmmduqtags(gatk_path, sorted_output, output_bam_fixed, reference_sequence, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_markduplicates(gatk_path, output_bam_fixed, marked_output_bam, metrics_file, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_sortsam_marked(gatk_path, input_bam, sorted_output, sort_order, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_baserecalibrator(gatk_path, input_bam, reference_sequence, output_table, known_sites, optional_args, log_function):
...
def run_applybqsr(gatk_path, input_bam, output_bam, reference_sequence, bqsr_recal_file, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_samtools_flagstat(input_bam, output_flagstat, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_samtools_stats(input_bam, output_stats, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_haplotypecaller(gatk_path, input_bam, output_vcf, reference_sequence, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_snvextraction(gatk_path, input_vcf, output_vcf, reference, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_indelextraction(gatk_path, input_vcf, output_vcf, reference, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_collectvariantcallingmetrics(gatk_path, input_vcf, output_path, dbsnp_file, optional_args, log_function):
    # Set up logging directory and files
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
...
def run_annovar(annovar_path, input_vcf, output_prefix, buildver, db_dir, optional_args, log_function):
    logging_dir = os.path.join(os.path.dirname(__file__), 'log')
    os.makedirs(logging_dir, exist_ok=True)
